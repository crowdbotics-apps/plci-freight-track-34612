...
## Project Structure
    ...
    ├── plci_freight_track_34612  # Django project configurations
...
1. Clone this repo and `cd plci_freight_track_34612`
...
2. Clone this repo and `cd plci_freight_track_34612`
